...
public class PokemonRepositoryAdapterSqlTest {
    ...
    @Test
    @SneakyThrows
    public void givenPokemon_whenInsertPokemonInSqlPostgresDataBase_thenReturnPokemonSaved() {
    ...
    @Test
    @SneakyThrows
    public void givenPokemon_whenUpdatePokemonInSqlPostgresDataBase_thenReturnPokemonUpdated() {
    ...
    @Test
    @SneakyThrows
    public void givenPokemon_whenDeletePokemonInSqlPostgresDataBase_thenDeletePokemon() {
    ...
    @Test
    @SneakyThrows
    public void givenPokemon_whenFindPokemonByNameInSqlPostgresDataBase_thenReturnPokemonList() {
    ...
    @Test
    @SneakyThrows
    public void givenPokemon_whenFindPokemonByNumberInSqlPostgresDataBase_thenReturnPokemon() {
    ...
    @Test
    @SneakyThrows
    public void givenPokemon_whenFindPokemonPageableInSqlPostgresDataBase_thenReturnPokemonList() {
    ...
    @Test
    @SneakyThrows
    public void givenPokemon_whenFindPokemonByIdInSqlPostgresDataBase_thenReturnPokemon() {
    ...
    @Test
    @SneakyThrows
    public void givenPokemon_whenExistsPokemonByIdInSqlPostgresDataBase_thenReturnTrue() {
