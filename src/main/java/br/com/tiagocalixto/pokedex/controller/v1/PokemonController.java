package br.com.tiagocalixto.pokedex.controller.v1;
...
public class PokemonController {
    ...
    public ResponseEntity<PokemonDto> searchByNumber(@Min(value = 1, message = NUMBER_INVALID_RANGE)
    ...
    public ResponseEntity<List<PokemonDto>> searchByByName(@Pattern(regexp = "^[a-zà-ú-A-ZÀ-Ú .']*$", message = NAME_IS_INVALID)
                                                                @Length(min = 3, max = 50,
    ...
    public ResponseEntity<List<PokemonDto>> searchAllPageable(@PathVariable Integer pageNumber) {
    ...
    public ResponseEntity<HttpStatus> delete(@Min(value = 1, message = NUMBER_INVALID_RANGE)
                                                    @Max(value = 151, message = NUMBER_INVALID_RANGE)
                                                    @PathVariable Long number) {
